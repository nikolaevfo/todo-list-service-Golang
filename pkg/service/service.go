...
// Описываем интерфейсы сервиса, их входные и выходные данные.
// Называем их исходя из доменной зоны бизнес-логики.
...
// в сервис TodoItem передается два аргумента, для связи задач и списков
